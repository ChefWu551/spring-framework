...
| 时间安排   | 进度                                                         | 完成状态 |
| ---------- | ------------------------------------------------------------ | -------- |
| 2021-03-10 | 笔记整理《图解HTTP》 1-3章节（27%），阅读《图解TCP/IP》第一章节 |          |
| 2021-03-11 | 笔记整理《图解HTTP》 4-6章节（54%），阅读《图解TCP/IP》第二章节 |          |
| 2021-03-12 | 笔记整理《图解HTTP》 7-9章节（72%），阅读《图解TCP/IP》第三章节 |          |
| 2021-03-13 | 笔记整理《图解HTTP》 10-11章节（100%），阅读《图解TCP/IP》第四、五章节 |          |
| 2021-03-14 | 阅读《图解TCP/IP》第六、七章节                               |          |
| 2021-03-15 | 阅读《图解TCP/IP》第八、九章节                               |          |
...
- **数据连路层: 以太网，无线LAN(local area network)**
